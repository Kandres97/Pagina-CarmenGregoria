...
const ContactSection = () => {
  ...
  return (
    <div 
      className="bg-gradient-to-b from-black via-purple-950 to-black py-16 relative overflow-hidden" 
      id="contacto"
      role="region" 
          ...
          <div className="bg-black/80 backdrop-blur-sm border border-[#FFD700]/30 rounded-lg p-8 md:p-12 shadow-2xl shadow-purple-900/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 text-center">
              <div>
                ...
                <p className="text-purple-200 text-lg">
                  Capital Mundial de la Brujería
                </p>
              </div>
              <div>
                <h3 className="text-[#FFD700] text-2xl font-bold mb-2">
            ...
            <div className="text-center space-y-6">
              ...
              <button
                ...
                name="contact-whatsapp-button"
                className="group relative inline-flex items-center justify-center px-8 py-6 text-lg font-bold text-white transition-all duration-300 bg-gradient-to-r from-green-600 via-green-500 to-green-600 rounded-full hover:from-green-700 hover:via-green-600 hover:to-green-700 shadow-lg hover:shadow-green-500/50 min-h-[48px] min-w-[48px] touch-manipulation mx-4 my-2"
              >
                <span 
                  className="absolute inset-0 w-full h-full rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"
                  aria-hidden="true"
                ></span>
                <svg 
                  viewBox="0 0 24 24" 
              ...
              <p className="text-purple-200 text-sm mt-6" role="note">
